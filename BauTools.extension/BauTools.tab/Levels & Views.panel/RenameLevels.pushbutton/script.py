...
if not os.path.exists(dll_path):
    ...
    from ZoningFloorArea.Views import RenameLevelsWindow
    
    doc = revit.doc
    if doc is None:
        UI.TaskDialog.Show("BauTools", "Please open a Revit project before launching Rename Levels.")
    else:
        win = RenameLevelsWindow(doc)
        win.ShowDialog()